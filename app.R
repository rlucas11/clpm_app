...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            p("The Random Intercept Cross-Lagged Panel Model (RI-CLPM) is equivalent to a STARTS model without the state variance; the Cross-Lagged Panel Model (CLPM) is equivalent to the RI-CLPM without the stable trait. Therefore you can specify different data generating models by setting these variances to zero."),
